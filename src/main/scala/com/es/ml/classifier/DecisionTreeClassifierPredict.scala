...
/**
  ...
  * DecisionTreeClassifier 预测
  */
object DecisionTreeClassifierPredict {
  /** 命令行参数 */
  case class Params(test_data: String = "", //测试数据路径
                    model_path: String = "", //模型路径
                    predict_out: String = "", //预测结果保存路径
                    appname: String = "DecisionTreeClassifier_Predict"
                   )
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("DecisionTreeClassifier_Predict") {
      head("DecisionTreeClassifier_Predict: 决策树分类预测.")
